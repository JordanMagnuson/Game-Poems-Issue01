...
<!--                    <h2 style="visibility:hidden">First Readers</h2>-->
    ...
    },
    {
        ...
        pageContent: `
                ...
                <p>What exactly is a "game poem"? That's one of the questions we're here to explore. I've always had an interest in bringing unusual lenses and inputs to my game making process, and poetry has long struck me as a particularly intriguing point of reference—precisely because of the historical gap that exists between videogames and poems. Videogames can sometimes feel like a sort of "anti-poetry," deeply entangled as they are with industrialism, capitalism, and militarism. They often fixate on hyperreal depictions of external objects, and often revolve around building things, collecting things, or blowing things up. Poetry, in this context, offers a challenge and a call towards some of those things we have historically struggled to make games about: subjective experiences, interior realities, complex relationships, unusual perspectives, the everyday mundane, and the messy loose ends of life. It also represents a radically different approach to creative practice and material engagement: where videogame production often involves a "bigger is better" logic, poets often strive for impact through smallness, constraint, and careful attention to form.</p>
                <p>People have been exploring and debating the nature of poetry in the context of words and language for thousands of years, and even a newer medium like cinema has seen discussion around concepts such as "film poems" and "poem films." But what about "game poems" and "poem games"? What happens when poets and artists are asked to craft a poem that is firstly a game? What happens when game makers are asked to think of their medium as a poetic material? What happens when people from non-technical backgrounds are invited to sit down with an accessible tool and make a tiny game in the same way that they might jot down a haiku? What sorts of videogames might emerge, about what sorts of human experiences?</p>
                <p>In the following pages you will find game poems made by artists, poets, scholars, and students, as well as indie developers and lead designers at AAA studios—each exploring different perspectives on what a game poem might be, in conversation with this issue's theme of "First Moves." Some pieces are gentle and approachable; others are conceptually knotty, formally experimental, or deliberately difficult. Some are richly produced; others embrace stark simplicity. Some come from individuals who have been making games for many years; others from creators who have only just gotten started. Their aesthetics range from cozy to grotesque, contemplative to chaotic. All are deeply personal short-form creations that reflect in one way or another on what it might mean for a game to be a poem—whether through material play, embrace of constraints, reliance on ambiguity and metaphor, positioning as riddle, conversation with poetic texts, or simply picking up certain lyric traditions such as brevity and emotional expressiveness. Importantly, all maintain a connecting thread to <em>videogames</em>, whether via classic game references, specific platform constraints, familiar interaction patterns, traditional iconography, recognizable aesthetics, or just enough "game feel" to evoke videogame expectations before subverting them. These are poets whose material is the stuff games are made of.</p>
                ...
                <p>Thanks for reading, and thanks for playing. If something in these pages moves you, surprises you, or sparks an idea, please share the magazine with your fellow (artists) (poets) (students) (scholars) (colleagues) (makers). And perhaps consider submitting something to our next issue.</p>
                <p class="no-indent"><br/>—Jordan Magnuson<br/>Founding Editor</p>
            `
    },
    {
        typeOfPage: "game",
    ...
    },
    {
        ...
        authorWebsite: "https://teterka.itch.io",
    ...
    },
    {
        ...
        authorWebsite: "https://papercookies.itch.io, https://bsky.app/profile/viktorrkraus.bsky.social",
    ...
    },
    {
        ...
        authorWebsite: "https://namidasai.itch.io",
        location: "London, UK",
        estimatedPlayTime: "Less than 5 minutes.",
        ...
        aboutProcess: "<em>Firsts</em> was made in Unity with intentionally minimalist art to let players project their own experiences. The concept was shaped mentally over time, exploring many vignette ideas before settling on a three-part haiku structure for stronger pacing. Once defined, the piece was built quickly and refined through testing to ensure movement and interaction carried the intended feeling.",
        acknowledgements: `The visual language draws on Sophie Tauber-Arp's "Vertical-Horizontal Composition" and László Moholy-Nagy's "K VII," which helped shape the abstract tone of the game.`,
        statement: `<p><em>Firsts</em> is a quiet exploration of what it feels like to begin—each gesture a small act of discovery, each scene a different kind of first step. It's rooted in a moment many of us know: leaving home, being reshaped by the world, and returning in a form our loved ones might still recognise—whether or not we meant to change.</p>`
    },
    {
        typeOfPage: "game",
        ...
        authorWebsite: "https://kbgamedesign.com",
        invited: true,
    ...
    },
    {
        ...
        authorWebsite: "https://ashleyrezvani.com, https://brittanywestlund.com, https://youtube.com/@katelloyd2247",
    ...
    },
    {
        ...
        madeWith: "Phaser",
        author: "Pippin Barr",
        authorWebsite: "https://pippinbarr.com",
        invited: true,
        ...
        aboutProcess: "<em>SNAKISMS 2</em> was made in Phaser 3 on top of the same basic implementation of <em>Snake</em> I'd used for <em>SNAKISMS</em>, <em>Sibilant Snakelikes</em>, and <em>SNAKISTS</em>. Reusing the same base code (and design) for something new is like a gift from the heavens and I recommend it.",
    ...
    },
    {
        ...
        authorWebsite: "https://brendan-allen.com",
    ...
    },
    {
        ...
        authorWebsite: "https://bulboka.itch.io",
        ...
        acknowledgements: `Music is the core of the entire game. It sets the rhythm and tone. In a sense, the game is a music video. The song is "Dia" by my good friend's band, "Kernherbst." kernherbst.bandcamp.com`,
    ...
    },
    {
        ...
        title: "The Ur Game",
        slug: "ur-game",
        src: "games/ur-game-rc6/index.html",
        background: "games/ur-game/background.jpg",
        madeWith: "Godot",
        author: "Gregory Avery-Weir",
        authorWebsite: "https://ludusnovus.net",
        editor: true,
    ...
    },
    {
        ...
        authorWebsite: "https://isaquepicaosanches.art",
    ...
    },
    {
        ...
        themeColor: "0000bf",
        background: "background.png",
        pageContent: `<!-- Notes will be generated in magazine.js -->`
    },
    {
        ...
        pageContent: `
                ...
                <div class="column">
                    ...
                    <p><em>Game Poems</em> was partially conceived and developed during a Fulbright fellowship at the University of Bergen, where the founding editor was an affiliate researcher at the Center for Digital Narrative, with support from the University of Southampton.</p>
               </div>
               <div class="column">
                    <h2>Accessibility</h2>
                    ...
                    <p><em>Game Poems</em> is an international publication. We support artists as individuals, not as representatives of the governments under which they live. We stand in solidarity with those affected by war and state violence, wherever they occur.</p>
                    <h2>Contact</h2>
