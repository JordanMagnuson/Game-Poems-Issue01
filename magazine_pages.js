...
<!--                    <h2 style="visibility:hidden">First Readers</h2>-->
    ...
    },
    {
        ...
        pageContent: `
                ...
                <p>In the following pages you will find game poems made by artists, poets, scholars, and students, as well as indie developers and lead designers at AAA studios—each exploring different perspectives on what a game poem might be, in conversation with this issue's theme of "First Moves." Some pieces are gentle and approachable; others are conceptually knotty, formally experimental, or deliberately difficult. Some are richly produced; others embrace stark simplicity. Some come from individuals who have been making games for many years; others from creators who have only just gotten started. Their aesthetics range from cozy to grotesque, contemplative to chaotic. All are deeply personal short-form creations that reflect in one way or another on what it might mean for a game to be a poem—whether through material play, embrace of constraints, reliance on ambiguity and metaphor, positioning as riddle, conversation with poetic texts, or simply picking up certain lyric traditions such as brevity and emotional expressiveness. Importantly, all maintain a connecting thread to <em>videogames</em>, whether via classic game references, specific platform constraints, familiar interaction patterns, traditional iconography, recognizable aesthetics, or just enough "game feel" to evoke videogame expectations before subverting them. These are poets working directly with the stuff games are made of.</p>
